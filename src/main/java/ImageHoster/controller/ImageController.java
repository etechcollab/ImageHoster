...
//As we are refering the image by its id, we are commenting the below statement.
    ...
    public String editImage(@RequestParam("imageId") Integer imageId, Model model, HttpSession session) {
        ...
        Boolean checkUserValidation = checkCurrentUser(image.getUser(), session);
    ...
    private Boolean checkCurrentUser(User user, HttpSession session) {
